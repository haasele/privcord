...
export interface IConfigOptions {
    ...
    /** Base URL of the server-creation API (enterprise-matrix-stack). When set, "Create new server" is shown. */
    server_creation_api_url?: string;
    /** Base URL of the federation directory (GET /api/v1/servers for discovery). */
    federation_directory_url?: string;
}
