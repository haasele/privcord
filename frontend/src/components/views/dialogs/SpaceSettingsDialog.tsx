...
import { SpaceSettingsModerationTab } from "../spaces/SpaceSettingsModerationTab";
...
export enum SpaceSettingsTab {
    ...
    Moderation = "SPACE_MODERATION_TAB",
...
const SpaceSettingsDialog: React.FC<IProps> = ({ matrixClient: cli, space, onFinished }) => {
    ...
    const tabs = useMemo(() => {
        return [
            ...
            new Tab(
                SpaceSettingsTab.Moderation,
                _td("discordify|moderation_tab_title"),
                <ShieldIcon />,
                <SpaceSettingsModerationTab matrixClient={cli} space={space} />,
            ),
